                            ...
                            <div className="flex border-b border-zinc-100 px-6 gap-6">
                                {['personal', 'professional', 'picture'].map(tab => (
                                    <button
                                        ...
                                        className={`py-4 text-sm font-bold uppercase tracking-wider border-b-2 transition-colors ${activeTab === tab ? 'border-zinc-900 text-zinc-900' : 'border-transparent text-zinc-400 hover:text-zinc-600'
                                            }`}
                                    >
                                        {tab}
                                    </button>
